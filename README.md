...
Для этого создайте папку `places` в папке `static` и положите туда файл .json с данными как указано на скриншоте ниже и после этого запустите скрипт в терминале.    
```
